# Generated by Django 3.0.3 on 2020-04-12 12:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usere_groups', to=settings.AUTH_USER_MODEL)),
            ],
            options={
